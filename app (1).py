    ...
    st.markdown(
        ...
        <div class="main-header">
            ...
            <div class="glossary-grid">
                ...
                <div class="glossary-card">
                    <div class="term">Límite elastico (YS)</div>
                    <div class="definition">
                ...
                <div class="glossary-card">
                    <div class="term">Elongación (%)</div>
                    <div class="definition">
                        Cuánto puede estirarse el acero antes de romperse. Un valor alto
                ...
                <div class="glossary-card">
                    ...
                    <div class="definition">
                        Qué tan resistente es a ser rayado o abollado. Se mide con la escala
    ...
    st.markdown(
        ...
        <div class="insight-box">
            <p>
                ...
                la resistencia máxima <em>{dir_uts}</em>
                (correlacion = {corr_uts:.2f}, relacion {strength_word}),
                mientras que la elongación <em>{dir_elong}</em>
                (correlacion = {corr_elong:.2f}).
                <strong>Esto refleja un principio fundamental:</strong>
                más carbono hace al acero más duro y resistente,
                pero también más fragil y menos capaz de estirarse sin romperse.
                La Elongación se multiplicó por 10 para que sea
...
def render_treatment_section(df: pd.DataFrame) -> None:
    ...
    st.markdown(
        ...
        <div class="insight-box">
            <p>
                <strong>Cómo leer estos graficos:</strong>
                la linea central de cada caja es la mediana (el valor que divide
                exactamente la mitad de los datos). La línea punteada es el promedio.
                En este conjunto de datos, el tratamiento
                <strong>{top_cond}</strong> produce la mayor resistencia promedio,
                mientras que <strong>{low_cond}</strong> da los valores más bajos.
                Esto muestra que el proceso de fabricación puede alterar las propiedades
